...
func main() {
	...
	ShoppingCartAPIService := openapi.NewShoppingCartAPIService()
	ShoppingCartAPIController := openapi.NewShoppingCartAPIController(ShoppingCartAPIService)

	router := openapi.NewRouter(ShoppingCartAPIController)
