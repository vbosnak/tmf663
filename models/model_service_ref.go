...
func AssertServiceRefRequired(obj ServiceRef) error {
...
// AssertServiceRefConstraints checks if the values respects the defined constraints
func AssertServiceRefConstraints(obj ServiceRef) error {
	return nil
}
