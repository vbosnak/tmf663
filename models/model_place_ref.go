...
func AssertPlaceRefRequired(obj PlaceRef) error {
...
// AssertPlaceRefConstraints checks if the values respects the defined constraints
func AssertPlaceRefConstraints(obj PlaceRef) error {
	return nil
}
