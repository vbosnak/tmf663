...
// AssertCartTermRequired checks if the required fields are not zero-ed
func AssertCartTermRequired(obj CartTerm) error {
...
// AssertCartTermConstraints checks if the values respects the defined constraints
func AssertCartTermConstraints(obj CartTerm) error {
