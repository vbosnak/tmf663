...
// AssertEventSubscriptionInputConstraints checks if the values respects the defined constraints
func AssertEventSubscriptionInputConstraints(obj EventSubscriptionInput) error {
	return nil
}
