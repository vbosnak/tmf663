...
// ProductOfferingPriceRef - ProductPriceOffering reference. An amount, usually of money, that is asked for or allowed when a ProductOffering is bought, rented, or leased
...
// AssertProductOfferingPriceRefRequired checks if the required fields are not zero-ed
func AssertProductOfferingPriceRefRequired(obj ProductOfferingPriceRef) error {
...
// AssertProductOfferingPriceRefConstraints checks if the values respects the defined constraints
func AssertProductOfferingPriceRefConstraints(obj ProductOfferingPriceRef) error {
	return nil
}
