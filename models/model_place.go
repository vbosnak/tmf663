...
func AssertPlaceRequired(obj Place) error {
	return nil
}

// AssertPlaceConstraints checks if the values respects the defined constraints
func AssertPlaceConstraints(obj Place) error {
	return nil
}
