...
// ProductOfferingRef - ProductOffering reference. A product offering represents entities that are orderable from the provider of the catalog, this resource includes pricing information.
...
// AssertProductOfferingRefRequired checks if the required fields are not zero-ed
func AssertProductOfferingRefRequired(obj ProductOfferingRef) error {
...
// AssertProductOfferingRefConstraints checks if the values respects the defined constraints
func AssertProductOfferingRefConstraints(obj ProductOfferingRef) error {
	return nil
}
