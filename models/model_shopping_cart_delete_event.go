...
// ShoppingCartDeleteEvent - The notification data structure
type ShoppingCartDeleteEvent struct {
	...
	Event ShoppingCartDeleteEventPayload `json:"event,omitempty"`
}

// AssertShoppingCartDeleteEventRequired checks if the required fields are not zero-ed
func AssertShoppingCartDeleteEventRequired(obj ShoppingCartDeleteEvent) error {
	if err := AssertShoppingCartDeleteEventPayloadRequired(obj.Event); err != nil {
		return err
	}
	return nil
}

// AssertShoppingCartDeleteEventConstraints checks if the values respects the defined constraints
func AssertShoppingCartDeleteEventConstraints(obj ShoppingCartDeleteEvent) error {
	if err := AssertShoppingCartDeleteEventPayloadConstraints(obj.Event); err != nil {
		return err
	}
	return nil
}
