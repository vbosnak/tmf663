...
// BillingAccountRef - BillingAccount reference. A BillingAccount is a detailed description of a bill structure.
...
// AssertBillingAccountRefRequired checks if the required fields are not zero-ed
func AssertBillingAccountRefRequired(obj BillingAccountRef) error {
...
// AssertBillingAccountRefConstraints checks if the values respects the defined constraints
func AssertBillingAccountRefConstraints(obj BillingAccountRef) error {
	return nil
}
