...
// ShoppingCartDeleteEventPayload - The event data structure
type ShoppingCartDeleteEventPayload struct {

	ShoppingCart ShoppingCart `json:"shoppingCart,omitempty"`
}

// AssertShoppingCartDeleteEventPayloadRequired checks if the required fields are not zero-ed
func AssertShoppingCartDeleteEventPayloadRequired(obj ShoppingCartDeleteEventPayload) error {
...
// AssertShoppingCartDeleteEventPayloadConstraints checks if the values respects the defined constraints
func AssertShoppingCartDeleteEventPayloadConstraints(obj ShoppingCartDeleteEventPayload) error {
