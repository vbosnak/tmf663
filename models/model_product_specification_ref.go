...
// ProductSpecificationRef - Product specification reference: A ProductSpecification is a detailed description of a tangible or intangible object made available externally in the form of a ProductOffering to customers or other parties playing a party role.
...
// AssertProductSpecificationRefRequired checks if the required fields are not zero-ed
func AssertProductSpecificationRefRequired(obj ProductSpecificationRef) error {
	...
	if err := AssertTargetProductSchemaRequired(obj.TargetProductSchema); err != nil {
		return err
	}
	return nil
}

// AssertProductSpecificationRefConstraints checks if the values respects the defined constraints
func AssertProductSpecificationRefConstraints(obj ProductSpecificationRef) error {
	if err := AssertTargetProductSchemaConstraints(obj.TargetProductSchema); err != nil {
		return err
	}
	return nil
}
