...
// AssertShoppingCartCreateRequired checks if the required fields are not zero-ed
func AssertShoppingCartCreateRequired(obj ShoppingCartCreate) error {
...
// AssertShoppingCartCreateConstraints checks if the values respects the defined constraints
func AssertShoppingCartCreateConstraints(obj ShoppingCartCreate) error {
	for _, el := range obj.CartItem {
