...
func AssertCharacteristicRequired(obj Characteristic) error {
...
// AssertCharacteristicConstraints checks if the values respects the defined constraints
func AssertCharacteristicConstraints(obj Characteristic) error {
	return nil
}
