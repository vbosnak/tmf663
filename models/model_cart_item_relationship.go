...
type CartItemRelationship struct {
...
// AssertCartItemRelationshipRequired checks if the required fields are not zero-ed
func AssertCartItemRelationshipRequired(obj CartItemRelationship) error {
	return nil
}

// AssertCartItemRelationshipConstraints checks if the values respects the defined constraints
func AssertCartItemRelationshipConstraints(obj CartItemRelationship) error {
	return nil
}
